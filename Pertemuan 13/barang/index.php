  ...
  <nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="icon mp-2 text-white">
            <h5>
                <i class="bi bi-basket-fill ml-3 m-3" data-toggle="tooltip"
                title="Keranjang Belanja"></i>
                <i class="bi bi-messenger m-3" data-toggle="tooltip"
                title="Surat Masuk"></i> 
                <i class="bi bi-bell-fill m-3" data-toggle="tooltip"
                title="Notifikasi"></i>
                <i class="bi bi-box-arrow-right m-3" data-toggle="tooltip"
                title="Keluar"></i>
             </h5>
        </div>
    </div>
