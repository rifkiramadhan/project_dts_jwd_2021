...
<body>
    ...
    <section class="container mb-3 pt-5 mt-5">
        ...
        <div class="col-md-8 p-3">
            <div class="card-body">
                ...
                <p class="card-text">Pendaftaran Anda telah <span class="badge rounded-pill bg-success">Diterima</span>.</p>
    ...
    <section class="container card text-center mt-5 mb-5">
        ...
        <div class="card-body">
            ...
            <a href="keluar.php" class="btn btn-secondary mt-3"><i class="bi bi-box-arrow-left"></i> Keluar</a>
        </div>
    </section>
