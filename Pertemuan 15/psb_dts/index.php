    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">Digitalent Online</a>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <div class="small text-black-50">Jl. Pagujaten RT 02/07 No. 26</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50"><a href="#!">rrxportal07@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50">+62 821 2211 6992</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="social d-flex justify-content-center">
                    <a class="mx-2" target="_blank" href="https://www.instagram.com/rifkiromdons/"><i class="bi bi-instagram"></i></a>
                    <a class="mx-2" target="_blank" href="https://www.facebook.com/rifki.ramadhan.359778/"><i class="bi bi-facebook"></i></a>
                    <a class="mx-2" target="_blank" href="https://github.com/rifkiramadhan"><i class="bi bi-code-square"></i></a>
                </div>
            </div>
        </section>
